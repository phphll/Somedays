...
public class POSPanel extends JPanel {
	...
	String[] menu = {
			"아메리카노","ICE 아메리카노","카페라떼","ICE 카페라떼",
			"카페모카","카푸치노","바닐라 라떼","ICE 바닐라 라떼",
			"녹차 라떼","�아이스티","자몽에이드","청포도 에이드",
			"딸기 스무디","블루베리 스무디","레몬티","유자차"};
	int[] price = {
			1500,1800,2500,2500,
			3000,3000,3500,3500,
			3500,2500,3500,3500,
	...
	class Screen extends JPanel{
		Screen(){
			...
			table.getTableHeader().setFont(new Font("Adobe Heiti Std", Font.BOLD, 15));
	...
	public POSPanel() {
		...
		SBtn[3].addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				tf.setText(String.valueOf(" 총 합계 : "+sum + "원"));
				tf.setFont(new Font("Adobe Heiti Std", Font.BOLD, 40));
			}
		});
	}
}
